...
<head>
    ...
    <!-- Vendor CSS-->
    <link href="<?php echo e(asset('template_assets/dist/css/select2.min.css')); ?>" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="<?php echo e(asset('template_assets/dist/css/signup.css')); ?>" rel="stylesheet">
...
<body style="background-image: url(<?php echo e(asset('/template_assets/assets/images/background/loginbackground.jpeg')); ?>);background-size:cover;background-repeat:no-repeat;">
    <div class="page-wrapper bg-red font-robo" style="padding-top: 45px;">
        <div class="wrapper wrapper--w1050">
            ...
            <?php endif; ?>
                <div class="card-heading" style="background-image: url(<?php echo e(asset('/template_assets/assets/images/services/aeps.jpg')); ?>);background-size:cover;background-repeat:no-repeat;width:360px;"></div>
                <div class="card-body" style="padding: 10px 40px !important;max-width: 540px;">
                    <img src="<?php echo e(asset('/template_assets/assets/images/logos/PAYMAMA_logos.png')); ?>" alt="Paymama Logo" style="margin-left: 90px;">
                    <hr>
                    ...
                    <form id="signupForm" method="POST" action="<?php echo e(route('signup')); ?>" autocomplete="off">
                        <?php echo csrf_field(); ?>   
    ...
    <script src="<?php echo e(asset('template_assets/dist/js/jquery.validate.min.js')); ?>"></script>
    ...
    <!-- This page plugin js -->
    <!-- Vendor JS-->
    <script src="<?php echo e(asset('template_assets/dist/js/select2.min.js')); ?>"></script>
    <script>
...
<!-- end document--><?php /**PATH /Users/mitalipatel/workspace/freelance/paymamaapp/resources/views/website/signup.blade.php ENDPATH**/ ?>