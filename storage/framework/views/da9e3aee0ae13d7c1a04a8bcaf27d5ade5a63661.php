...
<!-- <link href="<?php echo e(asset('dist/welcome/css/home3.css')); ?>" rel="stylesheet"> -->
            
<!-- <header style="background:url(<?php echo e(url('dist/welcome/images/slider_img1.png')); ?>) no-repeat; 
                            position: relative;
                            background-size: cover; object-fit: cover;"> -->
<header >
    <link rel="stylesheet" href="<?php echo e(asset('dist/setting/css/main.css')); ?>">
            ...
            <div class="fadeOut owl-carousel owl-theme" style="height:600px;">
                <div class="item" style="background-image: url(<?php echo e(asset('dist/welcome/images/banner-1.png')); ?>);background-size:cover;height:600px;">
                    <div class="Wrapper">
                ...
                <div class="item" style="background-image: url(<?php echo e(asset('dist/welcome/images/banner-2.png')); ?>);background-size:cover;height:600px;">
                    <div class="Wrapper">
                        <div class="slideInner">
                            <div class="imageSection">
                ...
                <div class="item" style="background-image: url(<?php echo e(asset('dist/welcome/images/banner-3.png')); ?>);height:600px;">
                    <div class="Wrapper">
                        <div class="slideInner">
                            <div class="imageSection">
                                <!-- <img src="https://masterpay.pro/assets_theme2/img/sbi.png" alt=""> -->
                ...
                <div class="item" style="background-image: url(<?php echo e(asset('dist/welcome/images/banner-1.png')); ?>);">
                    <div class="Wrapper">
                        <div class="slideInner">
                            <div class="imageSection">
                                <!-- <img src="https://masterpay.pro/assets_theme2/img/sbi.png" alt=""> -->
           ...
           <script src="<?php echo e(asset('dist/setting/js/owl.carousel.min.js')); ?>"></script>
    <script>
        // Owl Carousel Slider
        $(document).ready(function() {
             ...
             <div class="container" style="margin-top:50px;margin-bottom:50px;">
                    <div class="row">
                        <div class="col-md-3 service_item" >
                            <div class="col-md-12">
                                <img src="<?php echo e(asset('dist/welcome/images/Best_Commission_ic.png')); ?>" alt="">
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="col-md-3 service_item">
                            <div class="col-md-12">
                                <img src="<?php echo e(asset('dist/welcome/images/Best_Support_ic.png')); ?>" alt="">
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="col-md-3 service_item">
                            <div class="col-md-12">
                                <img src="<?php echo e(asset('dist/welcome/images/Super_Fast_ic.png')); ?>" alt="">
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="col-md-3 service_item">
                            ...
                            <div class="col-md-12">
                                <img src="<?php echo e(asset('dist/welcome/images/trusted_ic.png')); ?>" alt="">
                            </div>
                            <div class="col-md-12">
            ...
            <div class="containr-fluid about-section">
                            <div class="about-imgdiv">
                                <img src="<?php echo e(asset('dist/welcome/images/about_us_img.png')); ?>" class="img-fluid about-cover-img" alt="">
                                <img src="<?php echo e(asset('dist/welcome/images/about_us_below_img.png')); ?>" alt="" class="img-fluid about-cover-img" >
                            </div>
                            <div class="about-icon_t  col-md-3">
                                <img src="<?php echo e(asset('dist/welcome/images/smartpay_ic.png')); ?>" class="img-fluid " alt="" >

                            </div>
                            <!-- <img src="<?php echo e(asset('dist/welcome/images/smartpay_ic.png')); ?>" alt="" class="img-fluid about-icon" > -->
                        ...
                        <div>
                            <img src="<?php echo e(asset('dist/welcome/images/her_dukandar_img.png')); ?>" alt="" class="img-fluid about-person" >
            ...
            <!-- <div class="container-fluid" class="">
                            ...
                            <img src="<?php echo e(asset('dist/welcome/images/about_us_img.png')); ?>" alt="" class="img-fluid about-banner" >
                            ...
                            <img src="<?php echo e(asset('dist/welcome/images/about_us_below_img.png')); ?>" alt="" class="img-fluid " >
                        ...
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/Prepaid_Recharge_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/Postpaid_Recharge_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/DTH_Recharge_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/Money_Transfer_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/AEPS_withdrawal_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
                    ...
                    <div class="col-md-4 pt-3">
                        <div class="card text-center service-card" style="">
                            <div class="card-body ">
                                ...
                                <div class="middle-items ">
                                    <img src="<?php echo e(asset('dist/welcome/images/Electricity_ic.png')); ?>" alt="" 
                                        class="img-fluid " >
            ...
            <div class="container-fluid download-section" style="padding-left:0px; padding-right:0px;">
                    <div class="download-imgdiv">
                            <img src="<?php echo e(asset('dist/welcome/images/download_img.png')); ?>" class="img-fluid down-cover-img" alt="" st>
                    </div>
                    <div class="download-mob  col-md-3">
                        <img src="<?php echo e(asset('dist/welcome/images/front_mobile_img.png')); ?>" class="img-fluid " alt="" >
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-3 point-img" >
                                        <img src="<?php echo e(asset('dist/welcome/images/checkmark_ic.png')); ?>" alt="" class="img-fluid"> 
                                    </div>
                    ...
                    <div class="google-play">
                        <img src="<?php echo e(asset('dist/welcome/images/googleplay_img.png')); ?>" alt="" class="img-fluid">
                    </div>
            </div>
        ...
        <section class="OurPartnersSection" style="background-color: #f2f2f2;padding-top:40px; padding-bottom:50px;">
            <div class="Wrapper">
                ...
                <br><br>
                   ...
                   <div class="col-sm-2">
                        <img src="<?php echo e(asset('template_assets/assets/images/sbi.png')); ?>" style="width:90%;" alt="img">
                    </div>
                    <div class="col-sm-2">
                        <img src="<?php echo e(asset('template_assets/assets/images/paytem.png')); ?>" style="width:90%;"  alt="img">
                    </div>
                    <div class="col-sm-2">
                        <img src="<?php echo e(asset('template_assets/assets/images/axis.png')); ?>"  style="width:90%;" alt="img">
                    </div>
                    <div class="col-sm-2">
                        <img src="<?php echo e(asset('template_assets/assets/images/fino.png')); ?>" style="width:90%;"  alt="img">
                    </div>
                    <div class="col-sm-2">
                        <img src="<?php echo e(asset('template_assets/assets/images/airtel-payment-bank.png')); ?>" style="width:90%;"  alt="img">
                    </div>
                    <div class="col-sm-1"></div>
                </div>
...
<?php /**PATH /Users/mitalipatel/workspace/freelance/paymamaapp/resources/views/welcome.blade.php ENDPATH**/ ?>