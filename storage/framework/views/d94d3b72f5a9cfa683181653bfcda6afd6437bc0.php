...
footer .FooterParent .footerLogo
{
        ...
        <div class="FooterParent row" uk-scrollspy="cls: uk-animation-fade; target: > div; delay: 300;  repeat: false">
            <div class="col-lg-3 col-md-6" style="margin-left:-20px;">
                 <div class="footerLogo" style="padding-left: 0px;margin-left:27px;">
                   <img  src="<?php echo e(asset('template_assets/assets/images/logos/PAYMAMA_logos.png')); ?>" alt="" class="img-fluid" style="height:60px !important;width:290px !important;">
                </div>
            ...
            <div class="col-lg-3 col-md-6 menuLinks" style="padding-left: 55px;">
                ...
                <ul class="address" style="list-style-type: none;">
                    <li style="padding-top:5px;"><a href = "<?php echo e(url('/')); ?>" style="color:#2b2b2b;">Home </a></li>
                    <li><a href = "<?php echo e(url('/services')); ?>" style="font-family: 'Montserrat',sans-serif;color:#2b2b2b;">Services</a></li>

                                    <li><a href = "<?php echo e(url('/about_us')); ?>" style="font-family: 'Montserrat',sans-serif;color:black !important;">About Us </a></li>
                                    <li><a href = "<?php echo e(url('/contact_us')); ?>" style="font-family: 'Montserrat',sans-serif !important;color:black !important;">Contact Us </a></li>
                                    <li><a href = "<?php echo e(url('/about_us')); ?>" style="font-family: 'Montserrat',sans-serif !important;color:#2b2b2b;">IT Service's</a></li>
            ...
            <div class="col-lg-3 col-md-6 menuLinks" style="padding-left: 55px;">
                ...
                <ul class="address" style="list-style-type: none;">
                    <!-- <li><a href="#">FAQs</a></li> -->
                                    ...
                                    <li><a  style="color:#2b2b2b;font-family: 'Montserrat',sans-serif !important !important;" href = "<?php echo e(url('/privacy_policy')); ?>">Privacy Policy</a></li>
                                    <li><a  style="color:#2b2b2b;font-family: 'Montserrat',sans-serif !important;" href = "<?php echo e(url('/terms_conditions')); ?>">Terms & Condition's</a> </li>
                                    <li><a  style="color:#2b2b2b;font-family: 'Montserrat',sans-serif !important;" href = "<?php echo e(url('/grievance-redressal-policy')); ?>">Grievance Redressal Policy</a> </li>
                                    <li><a  style="color:#2b2b2b;font-family: 'Montserrat',sans-serif !important;" href = "<?php echo e(url('/refund_and_returnpolicy')); ?>">Refund & Cancellation Policy</a> </li>
            ...
            <div class="col-lg-3 col-md-6 connectWithUs" style="padding-left: 55px;">
                ...
                <div class="social-icon">
                                <a href="https://www.facebook.com/smartpayindia/">
                                    <img src="<?php echo e(asset('template_assets/assets/images/fb.PNG')); ?>" alt="" class="img-fluid">
                                </a>
                                <a href="https://instagram.com/smartpay_india?igshid=nk7ih6odsivx">
                                    <img src="<?php echo e(asset('template_assets/assets/images/instagram.PNG')); ?>" alt="" class="img-fluid">
                                </a>
                                <img src="<?php echo e(asset('template_assets/assets/images/linkedin.PNG')); ?>" alt="" class="img-fluid">
                                <img src="<?php echo e(asset('template_assets/assets/images/twitter.PNG')); ?>" alt="" class="img-fluid">

                            </div>
                            <br>
                <h5 style="color:#d40b2e;font-weight:bold;font-family: 'Cambria-Bold';">DOWNLOAD MOBILE APP</h5>
                <img src="<?php echo e(asset('template_assets/assets/images/googleplay.PNG')); ?>" alt="" class="img-fluid">
    ...
    <script src="<?php echo e(asset('dist/welcome/js/home.js')); ?>"></script>
    </body>
</html>
<?php /**PATH /Users/mitalipatel/workspace/freelance/paymamaapp/resources/views/website/footer.blade.php ENDPATH**/ ?>