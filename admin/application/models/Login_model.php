...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.password, BaseTbl.first_name, BaseTbl.last_name, BaseTbl.roleId, Roles.role');
    ...
    {
        $this->db->select('userId, email, first_name, last_name');
