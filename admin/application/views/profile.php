                                    ...
                                    <div class="row">
                                        <div class="col-md-12">                                
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="fname" name="fname" placeholder="<?php echo $fname; ?>" value="<?php echo set_value('fname', $fname); ?>" maxlength="100" />
                                            </div>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-12">                                
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="fname" name="lname" placeholder="<?php echo $lname; ?>" value="<?php echo set_value('lname', $lname); ?>" maxlength="100" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
