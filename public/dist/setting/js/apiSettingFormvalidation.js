...
$(function(){
	...
	var addUserForm = $("#addApiSettingForm");
	...
	var validator = addUserForm.validate({
		...
		rules:{
			...
			api_dtls :{ required : true },
			password : { required : true },
			password_confirmation : {required : true, equalTo: "#password"},
			// username : { required : true , remote:{	url:"checkApiSettingUsernameExists", type:"get"} },
		...
		messages:{
			...
			api_dtls :{ required : "This field is required" },
