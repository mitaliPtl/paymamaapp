var addEditModal = $('#smsGateSettingAddModal');
var chPwdModal = $('#smsGateSettingChPwdModal');
var addformID = $('#addSmsGateSettingForm');
var chPwdformID = $('#chPwdForm');

// Edit Functionality
$('.edit-btn').click(function () {
    var id = $(this).val();
    $.get('/edit_sms_gate_setting?id=' + id, function (data) {
...
$('.status-btn').change(function () {
    ...
    $.get('/change_sms_gate_set_active_status?id=' + rowId + '&status=' + activeStatus, function (data) {
        if (!data) {
...
$('.delete-btn').click(function () {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                var rowId = $(this).data('id');
                $.get('/change_sms_gate_set_delete_status?id=' + rowId, function (data) {
                    if (data) {
