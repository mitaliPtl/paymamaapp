...
$.ajax({
   ...
   success: function(response) {
       ...
       if (response['status'] == "true") {
           ...
           // window.location = "/public/money_transfer/";
           ...
           console.log('failed');
           $('#error_msg').text('Invalid OTP!! Retry')
       ...
       success: function(response) {
           ...
           if (response['status'] == "true") {
               ...
               resp_charges = ` <div class="col-12 col-lg-6">Transfer Amount <br>
                ...
                resp_trans_row = ``;
                trans_id ='';
                if ("fund_transfer_status" in response.result) {
                    
                    
                    $.each( response.result.fund_transfer_status, function( index, value ){
                        if (value.bank_transaction_id != null) {
                            trans_id = value.bank_transaction_id;
                        }else{
