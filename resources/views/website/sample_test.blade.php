...
<header >
                        <div class="header-imgdiv">
                            <img src="{{ asset('dist/welcome/images/slider_img1.png') }}" class="img-fluid header-cover-img" alt="" st>
                        </div>
                        
                                <img class="img-fluid banner-mobile" src="{{ asset('dist/welcome/images/slider_mobile_img.png') }}" alt="">                            
                        <div class="col-md-12 banner-des">
            ...
            <div class="container">
                <div class="our-serice">
                    <h2 class="multicolortext">OUR SERICES</h2>
                    <p>
                        At <b>SMARTPAY</b>, we give not just thr Best but Legendary satisfaction to our<br>
                ...
                <div class="row view-more" >
                    <div class="col text-center">
                        <button type="button" class="btn btn-outline-danger btn-lg view-more-btn">VIEW MORE</button>
                    </div>
                </div>
            </div>
            <!-- Our serices End -->
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 point-text">
                                        <p>High Margin in The Industry</p>
                                    </div>
                                </div>
