...
@section('page_content')
            ...
            <div class="alert alert-dismissible fade show" role="alert" id="alert_block" style="display:none;">
                ...
                <div class="card material-card">
                    <div class="card-body">
                        ...
                        <form  method="post" id="doTransactionForm">
                            @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @endif
                                         ...
                                         <tr>
                                            ...
                                            <td><input type="text" class="profile col-3" value="" name="transfer_amount" id="transfer_amount"></td>
    ...
    <div class="modal fade" id="comfirmtionModal">
        ...
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Transaction Summery </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
                ...
                <div class="modal-body">
                    <center>
                        ...
                        <table id="confirmation-table" class="table" style="font-size: 18px">
                            ...
                            <tr>
                                <th class="text-red">Beneficiary:</th>
                            ...
                            <tr>
                                <th class="text-red">
                                            ...
                                            @else
                                            Account No. <span class="colon-algin">:</span>
                                            @endif   
                                </th>
                                <td>{{ $receipientDtls->bank_account_number }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >{{ $receipientDtls->recipient_mobile_number }}</td>
                            </tr>
                            @endif --}}
    ...
    @endif
<script src="{{ asset('dist\service_type\js\custom_moneyTrans1.js') }}"></script>
@endsection