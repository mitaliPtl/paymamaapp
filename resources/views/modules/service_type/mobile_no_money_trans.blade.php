                ...
                <div class="row">
                    <div class="col-12">
                        <div class="material-card card">
                            <div class="card-body">
                                <form action="{{ route('get_sender_details') }}" method="post" id="senderMobForm"  autocomplete="off" >
                                    @csrf
                                    <input type="hidden" name="operator_name" value="{{ $data['money_trns_type'] }}">
                                    <div class="row">
                                        ...
                                        @if ($data['money_trns_type'] != 'BHIM_UPI') 
...
@elseif($data['page_name'] == 'sender_details')
    ...
    <!-- ============================================================== -->
            ...
            <input type="hidden" name="requestBody" id="requestBody" value="{{ $data['requestBody'] }}">  
            @if( $data['operator_name'] == 'BHIM_UPI')
            <input type="hidden" name="delete_beneficiary" id="DELETE_BENEFICIARY" value="{{ Config::get('constants.MONEY_TRANSFER.DELETE_RECEP_API_UPI') }}">  
            @else
            <input type="hidden" name="delete_beneficiary" id="DELETE_BENEFICIARY" value="{{ Config::get('constants.MONEY_TRANSFER.DELETE_RECEP_API') }}">  
            @endif
            <!-- ============================================================== -->
            <!-- Bread crumb and right sidebar toggle -->
            <!-- ============================================================== -->
...
@elseif($data['page_name'] == 'register_mobile_no')
            <!-- ============================================================== -->
            <!-- Bread crumb and right sidebar toggle -->
            <!-- ============================================================== -->
            <div class="page-breadcrumb border-bottom">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="material-card card">
                            <div class="card-body">
                                <form action="{{ route('register_sender') }}" method="post" id="senderMobForm" autocomplete="off" >
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label class="card-title" for="sender_mobile_number">MOBILE NO:</label>       
                                        </div>
                                        <div class="col-md-4">
                                                <input type="text" name="mobile_no" id="mobile_no" class="form-control" value="{{  $data['mobile_no'] }}"  placeholder="Enter Mobile No"required>
                                                <span id="message"></span>
                                        </div>
                                    </div>
                                    <hr>
    ...
    <!-- ============================================================== -->
    <!-- END Sender Details (If mobile no is registered) -->
    <!-- ============================================================== -->


@elseif($data['page_name'] == 'verify_otp')
    <!-- ============================================================== -->
    <!-- START Verify OTP (If mobile no is registered) -->
    <!-- ============================================================== -->
    <!-- ============================================================== -->
            <!-- Bread crumb and right sidebar toggle -->
            <!-- ============================================================== -->
                        ...
                        <div class="material-card card">
                            <div class="card-body">
                             <!--  <form action="" id="verifyOTPForm" method="post">-->
                                <form action="verify_otp" id="verifyOTPForm" method="post" autocomplete="off" >
                                <!-- <form id="verifyOTPForm"> -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                <label class="card-title" for="reg_otp"><i class="mdi mdi-cellphone"></i> MOBILE No.</label>
                                                <input type="text" name="mob_no" id="mob_no" class="form-control" value="{{  $data['mobile_no'] }}"   placeholder="Enter" required readonly>
                                                <span id="error_msg" style="color:red"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                <label class="card-title" for="reg_otp"><i class="mdi mdi-cellphone"></i> OTP</label>
                                                <input type="text" name="reg_otp" id="reg_otp" class="form-control"   placeholder="Enter"required>
                                                <span id="error_msg" style="color:red"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-sm-12">
                                        <button type="submit" class="btn success-grad btn-lg" id="verify-otp-sb-btns" style="margin-top:38px; height: calc(2.1rem + .75rem + 2px);">Verify</button>
    ...
    <!-- ============================================================== -->
    <!-- END Verify OTP (If mobile no is registered) -->
    <!-- ============================================================== -->
