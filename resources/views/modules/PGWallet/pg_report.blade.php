...
<div class="row">
    <div class="col-12">
        ...
        <div class="material-card card">
            <div class="card-body">
                <h4 class="card-title">Payment Gateway Reports</h4>
                <div class="row">
                    ...
                    {{-- @endif --}}
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>S. NO</th>
                                @foreach($paymentGatewayReportTH as $i => $head)
                                    <th>{{ $paymentGatewayReportTH[$i]['name'] }}</th>
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    @foreach($paymentGatewayReportTH as $i => $head)
                                        ...
                                        @if($head['label'] == 'trans_date')
                                            <td>
                                                {{isset($reports[$index]['trans_date']) && $reports[$index]['trans_date'] ? (date('d/m/y H:i:s',strtotime($reports[$index]['trans_date']))) : '' }}
                                            </td>
                                        @elseif($head['label'] == 'order_status')
                                            <td class="{{ $reports[$index][$head['label']] == 'SUCCESS' ? 'text-success' : ($reports[$index][$head['label']] == 'PENDING' ? 'text-warning' : 'text-danger') }}">
                                             {{ $reports[$index][$head['label']]}} 
                                             </td>
                                        @elseif($head['label'] == 'transaction_status')
                                            <td class="{{ $reports[$index][$head['label']] == 'Successful' ? 'text-success' : ($reports[$index][$head['label']] == 'PENDING' ? 'text-warning' : 'text-danger') }}">
                                             {{ $reports[$index][$head['label']]}} 
                                             </td>
                                             @elseif($head['label'] == 'superMerchantId')
                                            <td class="{{ $reports[$index][$head['label']] }}">
                                             {{ $reports[$index][$head['label']]}} 
                                             
                                             </td>
                                             @elseif($head['label'] == 'account_no')
                                            <td class="{{ $reports[$index][$head['label']] }}">
                                             {{ $reports[$index]['account_no']}} 
                                            ...
                                            <td class="{{ $reports[$index]['recipient_id'] }}">
                                             
                                             @php
                                             
                                              $var=$reports[$index]['recipient_id'];
                                              $dta=$var;
                                              if($dta != '')
                                              {
                                            ...
                                            <td class="{{ $reports[$index]['order_id'] }}">
                                             ICICI BANK
                                            
                                             </td>
                                              @elseif($head['label'] == 'api_alias')
                                             <td class="{{ $reports[$index]['api_alias'] }}">
                                             @if($reports[$index]['api_alias'] == 'rezorpay')
                                             RAZORPAY
                                             @else
                                             {{strtoupper($reports[$index]['api_alias'])}}
                                             @endif
                                            
                                             </td>
                                             @elseif($head['label'] == 'account_no')
                                            <td class="{{ $reports[$index]['account_no'] }}">
                                             {{ $reports[$index][$head['label']] }}
                                             </td>
                                             @elseif($head['label'] == 'transaction_id')
                                            <td class="{{ $reports[$index]['transaction_id'] }}">
                                              {{$reports[$index]['transaction_id']}}
                                             
                                             </td>
                                              @elseif($head['label'] == 'payment_type')
                                            <td class="{{ $reports[$index]['payment_type'] }}">
                                              {{strtoupper($reports[$index]['payment_type'])}}
                                             
                                             </td>
                                             @elseif($head['label'] == 'rt_commission')
                                            <td class="{{ $reports[$index]['rt_commission'] }}">
                                              {{strtoupper($reports[$index]['rt_commission'])}}
                                             
                                             </td>
                                             @elseif($head['label'] == 'imps_name')
                                            <td class="{{ $reports[$index]['imps_name'] }}">
                                              {{strtoupper($reports[$index]['imps_name'])}}
                                             
                                             </td>
                                             @elseif($head['label'] == 'bank_account_no')
                                            <td class="{{ $reports[$index]['bank_account_no'] }}">
                                              {{strtoupper($reports[$index]['bank_account_no'])}}
                                             
                                             </td>
                                             @elseif($head['label'] == 'billerID')
                                            <td class="{{ $reports[$index]['billerID'] }}">
                                              {{strtoupper($reports[$index]['billerID'])}}
                                             
                                             </td>
                                             @elseif($head['label'] == 'action')
                                            <td class="btn-group">
                                              
                                                @if(array_key_exists("order_status", $reports[$index]))
                                                    @if($reports[$index]['order_status'] != 'FAILED')
                                        ...
                                        @else
                                            <td> {{ @$reports[$index][$head['label']]}} </td>
                                        @endif
                                    @endforeach
