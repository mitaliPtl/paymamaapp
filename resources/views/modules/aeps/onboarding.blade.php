                                ...
                                <div class="row">
                                     ...
                                     <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" id="state_id" name="state_id" required="" style="height:47px;font-size:20px;" onchange="getcity()">
            									...
            									<option value="{{ $state['stateId'] }}" style="font-size:17px;">{{ $state['state'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="city" class="form-control"  id="response">
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="aadharNumber" name="aadharNumber" value="{{ isset($user->aadhar_no) ? str_replace('-','',$user->aadhar_no) : '' }}" required="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pan" name="pan" value="{{ isset($user->pan_no) ? $user->pan_no : '' }}" required="" readonly>
                                        </div>
                                    </div>
                                </div>
                                </fieldset>
