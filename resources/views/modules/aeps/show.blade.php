...
<style>
     ...
     <div class="modal fade" id="successModalnew" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content" style="width:870px !important;">
                ...
                <div class="modal-body" style="border:11px solid green;">
                   <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12"><img src="{{asset('template_assets/assets/images/logos/Paymama_330x90.png')}}" style="margin-top:10px;height:37px;width:47%;margin-bottom:12px;"></div>
                                <div class="col-md-6 col-lg-6 col-sm-12"><img src="{{asset('template_assets/icicibank.png')}}" style="margin-left:18px;margin-right:-10px;margin-top:0px;height:37px;width:47%;margin-bottom:12px;"></div>
                            </div>
                    <hr style="border:1px solid red;">
                   
                    <h2 style="color:green;text-align:center;font-weight:600;">
                        <i class="far fa-check-circle text-success" style="font-size: 40px;line-height: 1.1;color:#008000!important; display: inline-block !important;"></i>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered table stripped">
                                    @if(Session::get('transaction_amount'))
                                  
                                    <tr>
                                        <td style="font-size:12px;">AMOUNT</td><td style="font-size:12px;">{{ Session::get('transaction_amount') }}</td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <td style="font-size:12px;">DATE & TIME</td><td style="font-size:12px;">{{ Session::get('time') }}</td>
                                    </tr>
                                     <tr>
                                        <td style="font-size:12px;">AVAILABLE BALANCE</td><td style="font-size:12px;">{{ Session::get('balance_amount') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">AADHAR NUMBER</td><td style="font-size:12px;">{{ Session::get('aadharNumber') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">BANK</td><td style="font-size:12px;">{{ Session::get('bank_name') }}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td style="font-size:12px;">ORDER ID</td><td style="font-size:12px;">{{ Session::get('order_id') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">TRANSACTION ID</td><td style="font-size:12px;">{{ Session::get('transaction_id') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">CLIENT REFRENCE ID</td><td style="font-size:12px;">{{ Session::get('clientreferenceid') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">RRN NUMBER</td><td style="font-size:12px;">{{ Session::get('bankrrn') }}</td>
                                    </tr>
            ...
            <div class="modal-footer">
               <!--<button type="button" id="view-recipt"  onclick="getBillSurcharge( `{{ Session::get('order_id') }}` )" class="btn btn-warning btn-sm"><i class="mdi mdi-printer"></i> View </button>-->
                     ...
                     <button type="button" class="btn btn-lg success-grad" data-dismiss="modal" onclick="window.print();">Print Receipt</button>
  ...
  @else
    ...
    <script type="text/javascript">
    $(window).on('load', function() {
        $('#successModalministatement').modal('show');
    });
    </script>
  @endif
<script type="text/javascript">
...
<!--New Transaction Success screen as icici-->
  <style>
    ...
    <!--Ministatement modal starts here-->
    <!--@if(Session::has('ministatement'))-->
    <div class="modal fade" id="successModalministatement" role="dialog">
            <div class="modal-dialog">
    
              <!-- Modal content-->
              <div class="modal-content" style="width:670px !important;">
                ...
                <div class="modal-body" style="border:11px solid green;">
                   <div class="row">
                    ...
                    <h2 style="color:green;text-align:center;font-weight:600;">
                        <i class="far fa-check-circle text-success" style="font-size: 44px;line-height: 1.1;color:#008000!important; display: inline-block !important;"></i>
                        <center><h2>Success!</h2><br>
                        <h1 style="text-align:center" style="font-size:15px !important;">{{ Session::get('ministatement') }}</h1></center>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered table stripped">
                                    ...
                                    <tr align="center">
                                        <th style="font-size:17px;">Order ID</th> <td>{{ Session::get('order_id') }}</td>
                                        </tr>
                                        <tr align="center">
                                        <th style="font-size:17px;">Balance Amount</th><td>{{ Session::get('balance_amount') }}</td>
                                        </tr>
                                        <tr align="center">
                                        <th style="font-size:17px;">Aadhar No.</th><td>{{ Session::get('aadharNumber') }}</td>
                                        </tr>
                                        <tr align="center">
                                        <th style="font-size:17px;">Bank Name</th> <td>{{ Session::get('bank_name') }}</td>
                                ...
                                <table class="table table-bordered table stripped">
                                    ...
                                    <tr align="center">
                                        ...
                                        <th style="font-size:17px;">Transaction type</th>
                                        <th style="font-size:17px;">Narration</th>
                                        
                                    </tr>
                                    @if(Session::get('tableBody'))
                                     @foreach(Session::get('tableBody') as $report)
                                    <tr align="center">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-lg btn-dark" data-dismiss="modal">Close</button>
                {{ Session::forget('ministatement') }}
                {{ Session::forget('tableBody') }}
                {{ Session::forget('balance_amount') }}
                {{ Session::forget('datetime') }}
                {{ Session::forget('order_id') }}
                {{ Session::forget('aadharNumber') }}
         ...
         <div class="row" style="padding:20px;margin-top:-15px;">
                        ...
                        <nav style="margin-bottom:15px;">
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link nav-menus active" id="nav-contact-tab" data-toggle="tab" href="#nav-cashwithdrawal" role="tab" aria-controls="nav-contact" aria-selected="false" style="border-radius:20px;">Cash Withdrawal</a>
                                <a class="nav-item nav-link nav-menus"  id="nav-home-tab" data-toggle="tab" href="#nav-balanceinquiry" role="tab" aria-controls="nav-home" aria-selected="true" style="border-radius:20px;">Balance Inquiry</a>
                                <a class="nav-item nav-link nav-menus" id="nav-profile-tab" data-toggle="tab" href="#nav-ministatement" role="tab" aria-controls="nav-profile" aria-selected="false" style="border-radius:20px;">Mini Statement</a>
                                
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade" id="nav-balanceinquiry" role="tabpanel" aria-labelledby="nav-home-tab">
                            <form method="post" autocomplete="off" name="Form1" action="{{ route('aeps_transaction') }}" onfocus="showPosition()" onsubmit="return validateForm1()">
                                @csrf
                                <input type="hidden" id="longitude3" class="form-control" name="longitude">
                                <input type="hidden" id="latitude3" class="form-control" name="latitude">
                                <input type="hidden" id="" class="form-control" name="service_type" value="balance_enquiry">
                                <input type="hidden" id="capturescore1" class="form-control" name="capturescore1" required>
                                <div class="row">
                                            ...
                                            <div class="col-12">
                                              <div class="form-group">
                                                    <label for="bank">Select Bank</label>
                                                     <select class="select2 form-control custom-select" id="bank_names" name="bank_name" required="" style="width:100% !important;border:1px solid #aaa;">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control aadharNumber" name="aadharNumber" maxlength="14" required="">
                                                </div>
                                            </div>
                                   ...
                                   <div class="col-md-12" style="margin-left:-2px;">
									...
									<textarea style="display:none;" class="form-control" id="txtPidDatabalance" rows="5" name="txtPidDatabalance"></textarea>
								    <textarea  style="display:none;"  class="form-control"  id="txtPidOptionsbalance" name="txtPidOptionsbalance" style="width: 100%; height: 100px;"></textarea>
								    <input type="hidden" class="form-control" id="txtDeviceInfo" style="width: 100%; height: 160px;">
                                </div>
                            </form>
                            </div>
                            <div class="tab-pane fade" id="nav-ministatement" role="tabpanel" aria-labelledby="nav-ministatement">
                               <form method="post" name="Form2"  autocomplete="off"  action="{{ route('aeps_transaction') }}" onfocus="showPosition()" onsubmit="return validateForm2()">
                            @csrf
                            <input type="hidden" id="longitude2" class="form-control" name="longitude">
                            <input type="hidden" id="latitude2" class="form-control" name="latitude">
                            <input type="hidden" id="" class="form-control" name="service_type" value="mini_statement">
                            <input type="hidden" id="capturescore2" class="form-control" name="capturescore2" required>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-6">
                                          <div class="form-group">
                                                <label for="bank">Select Bank</label>
                                                <select class="select2 form-control custom-select" id="bank_name" name="bank_name" required="" style="width:100%;">
                                                    @foreach(json_decode($aeps_bank,true)['data'] as $id=>$bank)
                                                    @if($id != 0)
                									<option value="{{ $bank['iinno'] }}">{{ $bank['bankName'] }}</option>
                									@endif
                                ...
                                <div class="col-md-12">
                                   ...
                                   <!-- <a type="button" href="{{ route('home') }}" class="btn btn-dark">Cancel</a>-->
									...
									<textarea   style="display:none;" class="form-control" id="txtPidDatamini" rows="5" name="txtPidDatamini"></textarea>
								    <textarea  style="display:none;" class="form-control"  id="txtPidOptionsmini" name="txtPidOptionsmini" style="width: 100%; height: 100px;"></textarea>
								    <input type="hidden" class="form-control" id="txtDeviceInfo1" style="width: 100%; height: 160px;">
                    </form>
                            </div>
                            <div class="tab-pane fade show active" id="nav-cashwithdrawal" role="tabpanel" aria-labelledby="nav-cashwithdrawal">
                            <form method="post" name="Form"  autocomplete="off"  action="{{ route('aeps_transaction') }}" onfocus="showPosition()" onsubmit="return validateForm()">
                            @csrf
                          
                            <input type="hidden" id="capturescore" class="form-control" name="capturescore">
                            <input type="hidden" id="longitude1" class="form-control" name="longitude">
                            <input type="hidden" id="latitude1" class="form-control" name="latitude">
                            <input type="hidden" id="" class="form-control" name="service_type" value="cash_withdrawal">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-6">
                                    ...
                                    <div style="">
                	                <textarea  style="display:none;" class="form-control" id="txtPidData" rows="5" name="txtPidData"></textarea>
									
								    <textarea  class="form-control"  style="display:none;" id="txtPidOptions" name="PidOptions" style="width: 100%; height: 100px;"></textarea>
								    <input type="hidden" class="form-control" id="txtDeviceInfo" style="width: 100%; height: 160px;">
...
//     var a = document.forms["Form"]["capturescore"].value;
//     if (a == null || a == "") {
...
//     var b = document.forms["Form1"]["capturescore1"].value;
//     if (b == null || b == "") {
//       alert("Please Capture Fingerprint");
//       return false;
//     }
...
//     var c = document.forms["Form2"]["capturescore2"].value;
    ...
    function showPosition() {
        if(navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                $('#latitude3').val(position.coords.latitude);
                $('#longitude3').val(position.coords.longitude);
