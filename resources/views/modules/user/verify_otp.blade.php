...
<body class="container" style="background:url(template_assets/assets/images/big/auth-bg.jpg) no-repeat center center;margin-top:10%">
    ...
    @csrf
        <input type="hidden" value="{{ $user_id }}" name="verify_user_id" id="verify_user_id">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 text-center">
                ...
                <div class="form-group card" style="padding:30px">
                    ...
                    <label for="otp" style="font-weight:500;font-size:12px">Enter OTP</label>
                    <input type="text" class="form-control mb-2 text-center" maxlength="6" name="otp" autocomplete="off" required placeholder="6-digit OTP">
