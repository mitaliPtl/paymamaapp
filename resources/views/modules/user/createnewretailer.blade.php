...
<div class="page-content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="px-3 py-2  ">
                    <h4 class="font-weight-bolder">ADD NEW RETAILER</h4>
                </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="justify-content: center;">
                <button type="button" class="btn btn-primary success-grad btn-lg" id="recharge_ok"><a href="/distributor_fos_list">OK</a></button>
            </div>
        </div>
    </div>
</div>
