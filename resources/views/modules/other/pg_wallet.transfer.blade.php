...
<div class="row">
        ...
        <div class="material-card card">
            <div class="card-body">
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-default" style="border: 0px;">
                                    <tbody>
                                        <tr >
                                            <td class="label font-default"  style="font-size: 20px;width: 150px;border: 0px;"><i class="mdi mdi-account-outline"></i> User ID</td><td style="border: 0px;">:</td>
                                            <td class="label font-default"  style="font-size: 20px;border: 0px;"> <span id="tr_user_name"></span>{{ $data->username }}</td>
                                            </tr>
                                            
                                            <tr>
                                            <td class="label font-sm"  style="font-size: 20px;width: 150px;border: 0px;"><i class="mdi mdi-account"></i> Full Name </td><td style="border: 0px;">:</td>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><span id="tr_user_name1"></span>{{ $data->first_name }} </td>
                                            </tr>
                                            
                                            <tr>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><i class="mdi mdi-account-network"></i> User Type </td><td style="border: 0px;">:</td>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><span id="tr_user_name2"></span>{{ $data->user_name }}</td>
                                            </tr>
                                            
                                            <tr>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><i class="mdi mdi-cellphone"></i> Mobile </td><td style="border: 0px;">:</td>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><span id="tr_user_mobile"></span>{{ $data->mobile }}</td>
                                        </tr>
                                        
                                        <tr>
                                        <td class="label font-sm"  style="font-size: 20px;border: 0px;"><i class="mdi mdi-email"></i> Email </td><td style="border: 0px;">:</td>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;"><span id="tr_user_role"></span>{{ $data->email }}</td>
                                        </tr>
                                        <tr>
                                        <td class="label font-sm"  style="font-size: 20px;width: 200px;border: 0px;"><i class="mdi mdi-wallet"></i> Wallet Amount</td><td style="border: 0px;">:</td>
                                            <td class="label font-sm"  style="font-size: 20px;border: 0px;xolor:blue"><strong><i class="mdi mdi-currency-inr"></i> <span id="tr_user_balance"></span>{{ $data->wallet_balance }}/-</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                             ...
                             <div class="col-8">
                                <div class="form-group">
                                    <!-- <label for="amount">Tranfer Type</label> -->
                                     <p>
                                     <span style="float: left;margin-left:50px; text-transform: uppercase;">Transfer Balance <input type="radio" class="form-control" name="transfer_type" value="transfer"  style="height: 25px; float: left; "/></span>
                                     
                                     <span style="float: left; text-transform: uppercase;">Revert Balance <input type="radio" class="form-control" name="transfer_type" value="revert" style="height: 25px; float: left; "/></span>
                                     </p>
                                </div>
                            </div>
    ...
    border-color: #ffffff;"><i class="fa fa-reply"></i> Revert</button>
                    <button type="submit" class="btn btn-lg success-grad " style=" background-image: linear-gradient(to right, #251c63 , #dc182d);
     color: white;
    border-color: #ffffff;"><i class="fa fa-share"></i> Transfer</button>
                </div>
            </form>
                    @endforeach
